...
zNode.innerHTML =
    ...
    '</div>' +
    '</div>';
zNode.setAttribute('id', 'div_TicReplace_outer');
...
function bt_replaceClick(zEvent) {
    ...
    tr_replace(/\\Upd/, "Einspielen/Testen von Uppdates auf administrierten Systemen");
    /************\
     * Meetings *
    \************/
    ...
    tr_replace(/\\TMS/, "Teammeeting IT-Security");
